            ...
            <section id="featured-games" className="mb-6 ">
                ...
                <div id="games-grid" className="grid grid-cols-1 md:grid-cols-3 gap-2">
                    {Array.isArray(allGames) && allGames.length >= 4 ? (
                        <>
                            <div key={allGames[8].id}  className="`game-card md:col-span-2 md:row-span-1 hover:shadow-lg mr-5 transition transform cursor-pointer  bg-[url${allGames[8].background_image}]`" onClick={() => showGameDetails(allGames[8])}>
