        ...
        <section id="mobile" className="mb-[8%] mt-[7%]" data-aos="fade-up">
            ...
            <div className="container mx-auto py-8 px-4">
                <div className="flex flex-wrap justify-center gap-8">
                    <div data-aos="fade-right" data-aos-delay="0" className="game-card flex flex-col items-center  w-[45%] ">
                    ...
                    <div data-aos="fade-left" data-aos-delay="200" className="game-card flex flex-col items-center w-[45%] ">
