...
import { BsBell, BsCollection, BsGlobe2, BsLock, BsPeople, BsTag } from 'react-icons/bs';
...
export default function ProfileQuickLinks({ profile }) {
    ...
    return (
        <nav className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2 mt-4" aria-label={t('profileExtras.shortcuts')}>
