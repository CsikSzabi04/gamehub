            ...
            <div className="container mx-auto px-6 md:px-12 w-full">
                <div className="flex flex-col md:flex-row justify-between items-center">
                    <div className="mb-4 md:mb-0 text-center md:text-left">
                        <h3 className="text-xl font-bold">Game Data Hub</h3>
                    ...
                    <div className="mb-4 md:mb-0 text-center md:text-left">
                        ...
                        <ul className="space-y-2 mt-2">
                            ...
                            <li><a href="/about" className="hover:text-lime-600">About</a></li>
                ...
                <div className="mt-8 border-t border-gray-700 pt-4 text-center">
                    <p className="text-sm">&copy; 2025 Game Data Hub. All Rights Reserved.</p>
                    <div className="mt-2">
                        <a href="/terms" className="text-sm text-white hover:text-lime-600">Terms of Service</a> |
                        <a href="/privacy" className="text-sm text-white hover:text-lime-600"> Privacy Policy</a>
                    </div>
                </div>
            </div>
        </footer>
